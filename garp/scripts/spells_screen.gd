...
const NODE_BUTTON_SCENE: PackedScene = preload("res://addons/3d_player_controller/garp/scenes/spell_node_button.tscn")
const SLOT_SCENE: PackedScene = preload("res://addons/3d_player_controller/garp/scenes/inventory_slot.tscn")
