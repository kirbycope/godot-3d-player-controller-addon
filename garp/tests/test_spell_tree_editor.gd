...
const EDITOR_SCRIPT: GDScript = preload("res://addons/3d_player_controller/garp/editor/spell_tree_editor.gd")
...
func test_a_tree_built_into_another_resource_takes_the_file_it_is_saved_to() -> void:
	editor.tree = _two_spell_tree()
	tree.resource_path = "res://addons/3d_player_controller/garp/tests/host_scene.tscn::SpellTree_test"
	editor.set_cost(1, 3)
	assert_true(editor.dirty)
	watch_signals(editor)
...
func test_the_class_chain_and_the_header_tell_an_ability_tres_from_the_rest() -> void:
	...
	assert_eq(SpellTreeEditor._header_script_class("res://addons/3d_player_controller/garp/resources/spell_tree_demo.tres"), "SpellTree")
