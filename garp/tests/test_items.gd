...
const APPLE: Item = preload("res://addons/3d_player_controller/garp/resources/items/apple.tres")
const ORE: Item = preload("res://addons/3d_player_controller/garp/resources/items/iron_ore.tres")
const KEY: Item = preload("res://addons/3d_player_controller/garp/resources/items/old_key.tres")
const SWORD: Item = preload("res://addons/3d_player_controller/garp/resources/items/wooden_sword.tres")
const TEST_SAVE: String = "user://garp_test_inventory.tres"
const ContractActions: GDScript = preload("res://addons/3d_player_controller/garp/tests/contract_actions.gd")
...
func test_move_swaps_merges_and_moves() -> void:
	...
	var mushroom: Item = load("res://addons/3d_player_controller/garp/resources/items/mushroom.tres")
...
func test_an_equipment_item_goes_onto_the_skeleton() -> void:
	...
	assert_eq(sword.scene_file_path, "res://addons/3d_player_controller/garp/scenes/demo/wooden_sword.tscn", "The copy remembers its scene")
...
func test_forget_equipment_drops_nothing_and_add_equipment_scene_brings_it_back() -> void:
	...
	assert_eq(inventory.forget_equipment(sword), "res://addons/3d_player_controller/garp/scenes/demo/wooden_sword.tscn", "The scene path the sword can come back from")
	assert_false(inventory.has_equipment(Equipment.EquipmentType.SWORD_1H))
	...
	assert_eq(copy.scene_file_path, "res://addons/3d_player_controller/garp/scenes/demo/wooden_sword.tscn")
